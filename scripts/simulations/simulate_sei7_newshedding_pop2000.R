...
write_csv(full_obs_data, here::here("data", "newshedding_data", paste0("pop2000_fulldata.csv")))
write_csv(final_obs_data, here::here("data", "newshedding_data", paste0("pop2000_data.csv")))

sim_key <- read_csv(here::here("data", "newshedding_data", "sim_key.csv"))

key_frame <- data.frame(sim_num = 127,
                      sim_name = "newshedding_pop2000",
                      sim_filename = "simulate_sei7_newshedding_pop2000.R",
                      obsdata_filename = "data/newshedding_data/pop2000_data.csv",
                      fulldata_filename = "data/newshedding_data/pop2000_fulldata.csv",
                      N = N,
                      E_init = E_init,
                      gamma = gamma,
                      nu = nu,
